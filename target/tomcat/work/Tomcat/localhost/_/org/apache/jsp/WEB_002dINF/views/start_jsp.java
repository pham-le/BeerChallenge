 ...
 * Generated at: 2017-04-23 01:44:26 UTC
...
public final class start_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<link rel=\"stylesheet\" href=\"/resources/table/style.css\">\n");
      ...
      out.write("\t<ol>\n");
      out.write("\t\t<li>Press the \"Start\" button under the timer to begin the clock\n");
      out.write("\t\t\tand start playing! The \"Stop\" button will stop the game indefinitely.</li>\n");
      out.write("\t\t<li>Once a player drinks their shot, the player must click the\n");
      out.write("\t\t\tbutton with their name on it, and that time will be recorded.\n");
      out.write("\t\t\tClicking these buttons indicate which players have passed the round.</li>\n");
      out.write("\t\t<li>At every minute mark, a sound will play and players who have successfully indicated\n");
      out.write("\t\t\tthat they have drank their shot will have their button reactivated\n");
      out.write("\t\t\tfor the next round.</li>\n");
      out.write("\t\t<li>If a player fails to drink their shot (i.e click their\n");
      out.write("\t\t\tbutton) within that minute, it will be game over for that player. If\n");
      out.write("\t\t\tno one is able to finish their shots, meaning that none of the\n");
      out.write("\t\t\tbuttons have been pressed, then it is game over for the whole team\n");
      out.write("\t\t\tand the timer will stop.</li>\n");
      ...
      out.write("\t<input type=\"button\" style=\"color: red; background: white\" value=\"ENABLED \" disabled>\n");
      out.write("\t= This button is enabled, meaning the player is still in the game and must pass the round before the minute is up.<br/>\n");
      out.write("\t<input type=\"button\" style=\"color: green; background: #E8E8E8\" value=\"DISABLED\" disabled>\n");
      out.write("\t= This button is disabled, meaning the player has either already passed the round by clicking it, or is out of the game.\n");
      out.write("\t\n");
      ...
      out.write("\n");
      out.write("\t<p>\n");
      out.write("\t\t<a href=\"/scoreboard\" target=\"_blank\">Scoreboard</a>\n");
      out.write("\t</p>\n");
      out.write("\n");
  ...
  private boolean _jspx_meth_c_005fset_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/start.jsp(63,4) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f0.setVar("count");
    // /WEB-INF/views/start.jsp(63,4) name = value type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f0.setValue(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/start.jsp(63,4) '0'",_el_expressionfactory.createValueExpression("0",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /WEB-INF/views/start.jsp(63,4) name = scope type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/start.jsp(64,4) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/start.jsp(64,4) '${model.players}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${model.players}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_c_005fset_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /WEB-INF/views/start.jsp(78,5) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f1.setVar("count");
    // /WEB-INF/views/start.jsp(78,5) name = value type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fset_005f1.setValue(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/start.jsp(78,5) '${count + 1}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${count + 1}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /WEB-INF/views/start.jsp(78,5) name = scope type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
